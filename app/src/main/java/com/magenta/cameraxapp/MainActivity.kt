package com.magenta.cameraxapp
...
import com.magenta.cameraxapp.databinding.ActivityMainBinding
import java.io.File
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bind.startVideo.setOnClickListener {
            bind.startVideo.setImageResource(R.drawable.play_circle_red)
        ...
        bind.stopVideo.setOnClickListener {
            bind.startVideo.setImageResource(R.drawable.play_circle)
                ...
                bind.toggleFlash.setOnClickListener {
                    if (camera.cameraInfo.hasFlashUnit()) {
                        if (camera.cameraInfo.torchState.value == 0) {
                            ...
                            bind.toggleFlash.setImageResource(R.drawable.flashlight_off)
                        } else {
                            camera.cameraControl.enableTorch(false)
                            bind.toggleFlash.setImageResource(R.drawable.flashlight_on)
                        }
